...
Experimental design:
  - Baselines: K1 (matches the published Model 1 parameterisation) and A4
    (ToM + alignment at the paper's own levels).
...
def run_extension4(no_of_cycles=3, seed=None, output_dir=None, epochs=EPOCHS):
    ...
    for key, params in {**FACTORIAL_BASELINES, **EXT4_CONDITIONS}.items():
